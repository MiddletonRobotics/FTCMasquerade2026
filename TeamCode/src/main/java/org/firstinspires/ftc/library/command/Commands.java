...
public final class Commands {
     ...
     * @param command
     * @param instantCommand1
     * @param command1
     * @param commands        the commands to include
     * @return the command group
     * @see SequentialCommandGroup
     */
    public static Command sequence(com.seattlesolvers.solverslib.command.InstantCommand instantCommand, com.seattlesolvers.solverslib.command.InstantCommand command, com.seattlesolvers.solverslib.command.InstantCommand instantCommand1, com.seattlesolvers.solverslib.command.InstantCommand command1, Command... commands) {
