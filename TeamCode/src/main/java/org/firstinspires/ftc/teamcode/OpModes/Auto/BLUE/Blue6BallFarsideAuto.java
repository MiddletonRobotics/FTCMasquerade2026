...
@Autonomous(group = "BLUE", name = "Blue 6 Ball Far Auto")
public class Blue6BallFarsideAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        schedule(
                ...
                new SequentialCommandGroup(
                        ...
                        new InstantCommand(intake::intake).andThen(new WaitCommand(2000)),
                        ...
                        new InstantCommand(intake::stopIntake),
                        new InstantCommand(shooter::enableFlyWheel),
                        new FollowPathCommand(follower, Path.Path3, true, 1).alongWith(new InstantCommand(shooter::shootFar)),
